...
import { cargarEquipos } from "../services/EquiposServices";
...
export const EquiposProvider = ({children}) => {
    ...
    return(
        <EquiposContext.Provider value={{equipos,setEquipos,plantilla,setPlantilla, equipo,setEquipo, cargarEquiposHook}}>
            {children}
